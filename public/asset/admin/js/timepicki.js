	...
	$.fn.timepicki = function(options) {
		...
		return this.each(function() {
			...
			var top_arrow_button = (settings.increase_direction === 'down') ?
				"<div class='fa fa-chevron-up arrow1 action-prev'></div>" :
				"<div class='fa fa-chevron-up arrow1 action-next'></div>";
			var bottom_arrow_button = (settings.increase_direction === 'down') ?
				"<div class='fa fa-chevron-down arrow1 action-next'></div>" :
				"<div class='fa fa-chevron-down arrow1 action-prev'></div>";
